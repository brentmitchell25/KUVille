...
public class MainFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		// Creates the Upgrades database if this is the first time the program
		// is run
		if (firstRun) {
	...
	private void goToMap(boolean automaticLogin) {
		Session session = Session.getActiveSession();
		// Allows users to skip logins
		// User will not see Facebook feeds if they do not login
		// but will see Twitter feeds
	...
	// Facebook Login button is called from FacebookSDK folder
	// Twitter button is custom imported button
